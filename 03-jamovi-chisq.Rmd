...
Consider data [@data:Gammon2012:B12] [in Exercise\ 31.16 of the textbook](https://bookdown.org/pkaldunn/SRM-Textbook/AnalysisOddsRatio.html) (Table\ \@ref(tab:jamoviB12Data)).
...
[Appendix\ A](https://bookdown.org/pkaldunn/SRM-Textbook/AppendixDataSets.html).
...
Remember that **this data set is available from the textbook as `B12-Long`** in [Appendix\ A](https://bookdown.org/pkaldunn/SRM-Textbook/AppendixDataSets.html)
