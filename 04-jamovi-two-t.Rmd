...
Consider the face-plant data [@data:Wojcik:ForwardFall] [used in Exercise\ 30.11 of the textbook](https://peterkdunn.github.io/SRM-Textbook/AnalysisTwoMeans.html) (Table\ \@ref(tab:jamoviFacePlant)).
...
Remember, **this data set is available from the textbook as `ForwardFall.csv`** in [Appendix\ A](https://peterkdunn.github.io/SRM-Textbook/AppendixDataSets.html).
