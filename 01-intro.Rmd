...
Consider data [@data:Gammon2012:B12] [in Exercise\ 31.16 of the textbook](https://peterkdunn.github.io/SRM-Textbook/AnalysisOddsRatio.html) (shown here in Table\ \@ref(tab:jamoviB12Data)).
...
Consider the face-plant data [@data:Wojcik:ForwardFall] [used in Exercise\ 30.11 of the textbook](https://bookdown.org/pkaldunn/SRM-Textbook/AnalysisTwoMeans.html) (shown here in Table\ \@ref(tab:jamoviFacePlant)).
