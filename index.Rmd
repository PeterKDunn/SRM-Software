...
<!-- To publish: bookdown::publish_book() -->
...
This manual explains how to conduct some of the analyses in the book [*Scientific Research Method*](https://bookdown.org/pkaldunn/SRM-Textbook/) using software.
